...
export type FormType = 'login' | 'sign';

interface HomePageStyleProps {
  form: FormType;
}
...
const LoginSelector = styled.div<HomePageStyleProps>`
  background-color: ${({ form }) => (form === 'login' ? '#e0e0e0' : '#f5f5f5')};
`;

const SignUpSelector = styled.div<HomePageStyleProps>`
